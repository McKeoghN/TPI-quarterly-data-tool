...
Ireland_GVA = pd.read_csv('../src/Ireland_Data.csv')
...
EuroZone_Productivity.to_excel("EuroZone_Productivity_Adjusted.xlsx", index=False)
...
EuroZone_Productivity_IE.to_excel("EuroZone_Productivity_Eurostat.xlsx", index=False)
print("Original")
